...
# Remove overall title for cleaner Nature style
...
# Save figure
plt.savefig('figures/figure2.jpg', dpi=300, bbox_inches='tight', facecolor='white')
print(f'\nFigure saved as figures/figure2.jpg')
